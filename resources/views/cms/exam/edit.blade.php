...
@section('content')
    ...
    @endif
    <form class="shadow p-4 rounded-md" method="POST" action="{{route('ex.update', $exam->id)}}">
        @csrf
        @method('PATCH')
        <div>
            <div>
                ...
                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="name" name="name" autofocus autocomplete="off" value="{{$exam->name}}"
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <select id="exam_type_id" name="exam_type_id"
                            ...
                            @foreach($types as $key=>$type)
                                <option value="{{$key}}" {{$exam->exam_type_id == $key ? 'selected' : ''}}>{{$type}}</option>
                            @endforeach
                        </select>
                    </div>
